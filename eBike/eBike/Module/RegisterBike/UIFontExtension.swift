...
extension UIFont {
    ...
    /// Circular Spotify Bold 100
    static let bold100: UIFont = FontFamily.CircularSpotifyText.bold.font(size: 100.0)
    
    /// Circular Spotify Bold 80
    static let bold80: UIFont = FontFamily.CircularSpotifyText.bold.font(size: 80.0)
    ...
    /// Circular Spotify Bold 14
    static let bold14: UIFont = FontFamily.CircularSpotifyText.bold.font(size: 14.0)
